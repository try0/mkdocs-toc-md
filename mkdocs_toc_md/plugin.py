...
class TocMdPlugin(BasePlugin):
    ...
    config_scheme = (
        ...
        ('subdir_template_name', config_options.Type(str, default=None)),
    ...
    def get_template_name_candidates(self, target_dir=None):
        ...
        if target_dir:
            ...
            template_names.append('index.' + parent_dir_name + '.md.j2')

            subdir_template_name = self.config['subdir_template_name']
            if subdir_template_name:
                template_names.append(subdir_template_name)
